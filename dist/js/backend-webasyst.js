...
/* harmony import */ var core_js_modules_es_number_constructor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(72);
/* harmony import */ var core_js_modules_es_number_constructor__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_number_constructor__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_object_assign__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(123);
...
/* harmony import */ var core_js_modules_es_promise__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(125);
/* harmony import */ var core_js_modules_es_promise__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_promise__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var core_js_modules_es_promise_finally__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(130);
...
/* harmony import */ var core_js_modules_web_timers__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(89);
...
var app = new Vue({
  ...
  methods: {
    ...
    delGroup: function delGroup() {
      if (this.groups_count > 1) {
        var regExp = new RegExp('^groups_' + this.groups_count);
    ...
    selectTab: function selectTab(e, tabNumber, numberGroups) {
      var tabButton = e.target.parentElement;
      if (e.target.tagName === 'LI') tabButton = e.target;
      var key = 'groups_' + numberGroups + '_tab_active';
      this.settings[key] = tabNumber;
    },
    addTab: function addTab(e, numberGroups) {
      var groupCountKey = 'groups_' + numberGroups + '_group_count_t-number';
      this.settings[groupCountKey]++;
      var groupActiveKey = 'groups_' + numberGroups + '_group_' + this.settings[groupCountKey] + '_active';
      Vue.set(this.settings, groupActiveKey, true);
      var storiesCountKey = 'groups_' + numberGroups + '_group_' + this.settings[groupCountKey] + '_stories_count_t-number';
      Vue.set(this.settings, storiesCountKey, 1);
      var storyNumberkey = 'groups_' + numberGroups + '_group_' + this.settings[groupCountKey] + '_story_1_t-number';
      Vue.set(this.settings, storyNumberkey, false);
      this.settings['groups_' + numberGroups + '_tab_active'] = this.settings[groupCountKey];
    },
    delTab: function delTab(e, numberGroups) {
      var groupCountKey = 'groups_' + numberGroups + '_group_count_t-number';

      if (this.settings[groupCountKey] > 1) {
        var regExp = new RegExp('^groups_' + numberGroups + '_group_' + this.settings[groupCountKey]);
    ...
    addStory: function addStory(e, numberGroups, numberGroup) {
      var storiesCountKey = 'groups_' + numberGroups + '_group_' + numberGroup + '_stories_count_t-number';
      this.settings[storiesCountKey]++;
      Vue.set(this.settings, storiesCountKey, this.settings[storiesCountKey]);
      var storyNumberkey = 'groups_' + numberGroups + '_group_' + numberGroup + '_story_' + this.settings[storiesCountKey] + '_t-number';
      Vue.set(this.settings, storyNumberkey, false);
    },
    delStory: function delStory(e, numberGroups, numberGroup) {
      var key = 'groups_' + numberGroups + '_group_' + numberGroup + '_stories_count_t-number';

      if (this.settings[key] > 1) {
        var regExp = new RegExp('^groups_' + numberGroups + '_group_' + numberGroup + '_story_' + this.settings[key]);
    ...
    storyShow: function storyShow(e, numberGroups, numberGroup, numberStory) {
      var key = 'groups_' + numberGroups + '_group_' + numberGroup + '_story_' + numberStory + '_t-number';
      Vue.set(this.settings, key, !this.settings[key]);
    },
    delImageProduct: function delImageProduct(e, key) {
      this.settings[key] = '';
    },
    checkImage: function checkImage(e) {
      var valueElem = e.target.parentElement.parentElement;
      var hintError;

      for (var index = 0; index < valueElem.children.length; index++) {
        var elem = valueElem.children[index];
    ...
    openElem: function openElem(e) {
      if (!e.target.className || !/hidden-fields__heading/gi.test(e.target.className)) return;
      var h5 = e.target;
      var fields = e.target.parentNode.children[1];
      var icon = h5.children[0];
  ...
  mounted: function mounted() {
    ...
    axios.get(this.url + 'sitestories-settings/').then(function (response) {
...
var global = __webpack_require__(0);
var getBuiltIn = __webpack_require__(13);
var NativePromise = __webpack_require__(97);
var redefine = __webpack_require__(7);
...
var isForced = __webpack_require__(16);
var wellKnownSymbol = __webpack_require__(2);
var V8_VERSION = __webpack_require__(129);
